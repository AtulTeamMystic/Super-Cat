...
public class TrackManager : MonoBehaviour
{
    ...
    public float RatlaneOffset = 2.5f;
    ...
    public IEnumerator Begin()
    {
        if (!m_Rerun)
        {
            ...
            Camera.main.transform.localPosition = new Vector3(   Camera.main.transform.position .x, 3.5f,-4.8f);
    ...
    public void End()
    {
        ...
        //Camera.main.transform.position = new Vector3(Camera.main.transform.position .x, 3.5f,-5.7f);
            ...
            while (currentWorldPos < segment.worldLength)
            {
                ...
                if (laneValid)
                {
                    ...
                    else
                    {
                        ...
                        toUse.transform.position = new Vector3(pos.x, 0.5f, pos.z);
