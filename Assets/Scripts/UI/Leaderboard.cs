...
public class Leaderboard : MonoBehaviour
{
	...
	public void Open()
	{
		...
		LeanTween.scale(leaderboardBg, new Vector3(1, 1, 1), 0.3f); 
		Populate();
	}

	public void Close()
	{
		LoadoutState state = FindObjectOfType<LoadoutState>();
		gameObject.SetActive(false);
		LeanTween.scale(leaderboardBg, new Vector3(0, 0, 0), 0.3f); 
		state.charPosition.gameObject.SetActive(true);
	}
