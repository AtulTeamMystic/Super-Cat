...
public class LoadoutState : AState
{
    ...
    [Header("Char UI")] public Text charNameDisplay;
    public RectTransform charSelect;
    public Transform charPosition;

    [Header("Theme UI")] public Text themeNameDisplay;
    public RectTransform themeSelect;
    public Image themeIcon;

    [Header("PowerUp UI")] public RectTransform powerupSelect;
    public Image powerupIcon;
    public Text powerupCount;
    public Sprite noItemIcon;

    [Header("Accessory UI")] public RectTransform accessoriesSelector;
    public Text accesoryNameDisplay;
    public Image accessoryIconDisplay;

    [Header("Other Data")] public Leaderboard leaderboard;
    ...
    [Header("Prefabs")] public ConsumableIcon consumableIcon;
    ...
    protected readonly Quaternion k_FlippedYAxisRotation = Quaternion.Euler(0f, 0f, 0f);

    [Header("_________Inventory__________")] [SerializeField]
    ...
    private void Start()
    {
        ...
        inventoryBackButton.onClick.AddListener(CloseInventory);
    }
    ...
    public override void Tick()
    {
        ...
        if (m_Character != null)
        {
            //  m_Character.transform.Rotate(0, k_CharacterRotationSpeed * Time.deltaTime, 0, Space.`);
        }
    ...
    public IEnumerator PopulateCharacters()
    {
        ...
        if (!m_IsLoadingCharacter)
        {
            ...
            {
                Character c =
                    CharacterDatabase.GetCharacter(PlayerData.instance.characters[PlayerData.instance.usedCharacter]);
                ...
                if (c != null)
                {
                    ...
                    //    Debug.Log(" newChar.transform.rotation " +    newChar.transform.rotation);
    ...
    public void ChangeConsumable(int dir)
    {
        ...
        do
        {
            ...
            int count = 0;
            if (PlayerData.instance.consumables.TryGetValue((Consumable.ConsumableType) m_UsedPowerupIndex,
                out count) && count > 0)
            {
                found = true;
            }
    ...
    void OpenInventory()
    {
        ...
        LeanTween.scale(inventoryPanel, new Vector3(1, 1, 1), 0.3f);
    } 
    
    void CloseInventory()
    {
        inventoryPanel.SetActive(false);
        charPosition.gameObject.SetActive(true);
        LeanTween.scale(inventoryPanel, new Vector3(0, 0, 0), 0.3f);
    }
