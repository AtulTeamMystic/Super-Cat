...
public class PatrollingObstacle : Obstacle
{
	...
	[SerializeField] internal GameObject dog;
    ...
    public override void Setup()
	{
		...
		m_OriginalPosition = transform.localPosition + transform.right * m_Segement.manager.RatlaneOffset;
        ...
        m_MaxSpeed = (m_Segement.manager.RatlaneOffset * k_LaneOffsetToFullWidth * 2) / actualTime;
	...
	void Update()
	{
        ...
        transform.localPosition = m_OriginalPosition - transform.right * Mathf.PingPong(m_CurrentPos, m_Segement.manager.RatlaneOffset * k_LaneOffsetToFullWidth);
	}
