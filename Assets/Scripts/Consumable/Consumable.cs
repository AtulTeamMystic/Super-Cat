...
public abstract class Consumable : MonoBehaviour
{
    ...
    public enum ConsumableType
    {
        NONE,
        MAX_COUNT,
        COIN_MAG = StaticData.MagnetID ,
        EXTRALIFE = StaticData.ExtralifeId,
        INVINCIBILITY = StaticData.InvincibltyId,
        SCORE_MULTIPLAYER =StaticData.ScoreMultipierId,
    }
    ...
    public abstract int GetConsumableId();
